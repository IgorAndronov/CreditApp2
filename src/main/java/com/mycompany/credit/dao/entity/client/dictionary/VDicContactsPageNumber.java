 ...
 */
@Entity
@Table(name = "v_dic_contacts_page_number", schema = "icredit", catalog = "postgres")
public class VDicContactsPageNumber {
    private Integer id;
    ...
    public boolean equals(Object o) {
        ...
        VDicContactsPageNumber that = (VDicContactsPageNumber) o;
