 ...
 */
@Entity
@Table(name = "v_dic_residency", schema = "icredit", catalog = "postgres")
public class VDicResidency {
    private Integer id;
    ...
    @Basic
    @Column(name = "value", nullable = true, insertable = true, updatable = true, length = 1)
    ...
    public boolean equals(Object o) {
        ...
        VDicResidency that = (VDicResidency) o;
